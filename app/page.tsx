...
export default function HomePage() {
  ...
  return (
    <div>
      <Hero
        eyebrow="Trusted by 15,900+ Patients Online"
      ...
      <Marquee
        items={["Gentle Care", "15+ Years Experience", "15,900+ Community", "Book Now"]}
      ...
      <ScrollReveal className="container-page grid gap-6 py-20 sm:grid-cols-3">
        {[
          { icon: ShieldCheck, title: "Experienced Dentists", desc: "15+ years treating families across Cantt, Lahore." },
          { icon: Smile, title: "Gentle, Modern Care", desc: "Comfortable treatment for both children and adults." },
          { icon: Users, title: "15,900+ Community", desc: "One of the most-followed dental practices in Cantt." },
        ].map((item) => (
